...
function makeStreets(){
	var column_round3D = EXTRUDE([1.2])(arc(2*PI, 0, 0.5))
	var tower1 = T([0,1,2])([3.5,13.95,0.2])(column_round3D)
	var tower2 = T([0,1,2])([6.5,13.95,0.2])(column_round3D)
	var stripes = STRUCT([SIMPLEX_GRID([[-9.7, +0.05],[-12.5, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2,0.1, -0.2, 0.1, -0.2],[-1.25, + 0.01]]),SIMPLEX_GRID([[-0.1, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1,-0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1,-0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1,-0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2, 0.1, -0.2,0.1, -0.2, 0.1, -0.2],[-13.95, 0.05],[-1.25, + 0.01]])]);
	var streets = COLOR(rgb01(42,41,34))(STRUCT([SIMPLEX_GRID([[- 0.5, + 0.5],[-14.1, 4-0.1],[-1, + 0.25]]), SIMPLEX_GRID([[- 1, - 0.5, +0.5],[-14.1, 4-0.1],[-1, + 0.25]]),
			SIMPLEX_GRID([[-9.5, +0.5],[-12.3, 5],[-1, + 0.25]]),SIMPLEX_GRID([[10],[-13.7, 0.5],[-1, 0.25]]), SIMPLEX_GRID([[- 10.5, + 0.5, -0.5, 0.5, -0.5, 0.5],[-12, 5],[-1, + 0.25]])]))
	return STRUCT([stripes, streets, tower1, tower2]);
}
...
mountain.makeModel = function () {
	...
	return STRUCT([lake, streets, mountain, houseSettlement, houseSettlement2, treeCollection])
}; 

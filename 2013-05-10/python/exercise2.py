...
VIEW(STRUCT([T([1,2,3])([-1.5,-4,1])(spoilerSupport), highClosure, vertProf, T([2])([-3])(highClosure), T([1,2])([10,-0.5])(pilotSiegeUp), T([1,2])([10,-0.5])(pilotSiegeDown), profileDown, profileUp, T([1,3])([-1.5,1.5])(back_spoiler), T([1,2,3])([20,1.5,0.5])(front_spoiler)]))
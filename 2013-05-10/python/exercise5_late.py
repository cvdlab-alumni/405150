...
bottom1 = MAP(BEZIER(S2)([BEZIER(S1)(curve12),BEZIER(S1)(curve11)]))(dom2D)
bottom2 = MAP(BEZIER(S2)([BEZIER(S1)(curve14),BEZIER(S1)(curve13)]))(dom2D)

bottom = COLOR([0,0,0,1])(STRUCT([bottom1,bottom2]))

#superficie posteriore
behind = COLOR([0.95,0.105,0.105,1])(MAP(BEZIER(S2)([BEZIER(S1)(rect11),BEZIER(S1)(rect21)]))(dom2D))

## profili 
vertProf = STRUCT([vertProf1,vertProf2,vertProf3,vertProf4,vertProf5,vertProf6])
pilotSiegeUp = STRUCT([c23,c24,c25,c26,c27])
profileDown = STRUCT([c6])
profileUp = STRUCT([c7,c8,c9,c10,c11,c12])

VIEW(STRUCT([highClosureSurface, bottom, behind, vertProf, T([1,2,3])([12,-1.1,1.75])(steeringWheel), steeringMast, forwardWheels, T([1,2])([-18,0.5])(S([1,2,3])([1.25,1.25,1.25])(forwardWheels)), T([1,2])([10,-0.5])(pilotSiegeUp), profileDown, profileUp, bSpoilerSurface,T([1,2,3])([20,1.5,0.5])(fSpoilerSurface)]))
